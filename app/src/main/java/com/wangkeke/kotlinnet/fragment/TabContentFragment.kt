 ...
 * [TabContentFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [TabContentFragment.newInstance] factory method to
...
class TabContentFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String): TabContentFragment {
